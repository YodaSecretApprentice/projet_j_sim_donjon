...
public class Monstre extends ElementMobile {
	...
	public Monstre(final Map map) {
		super(map, "monstre.jpg", "Monstre");	//On définit une image et le nom du monstre
	}
		...
		if(vie!=0){	//Si le monstre n'est pas mort
			if(stop==0){	//S'il ne doit pas s'arréter
				...
				if(demiTour)	//S'il doit faire demi-tour, cela lui prendra un tour de plus
				{
					...
					final ElementMobile nord1 = this.map.getElementMobile(this.getX(), this.getY()-1);	//On définit trois éléments mobiles dans le voisinnage du monstre
					final ElementMobile nord2 = this.map.getElementMobile(this.getX()+1, this.getY());
					final ElementMobile nord3 = this.map.getElementMobile(this.getX()-1, this.getY());
					...
					else if (!this.map.getXY(x, y-1).estVide()){	//S'il y a un obstacle devant le monstre
					...
					final ElementMobile est1 = this.map.getElementMobile(this.getX()+1, this.getY());
					final ElementMobile est2 = this.map.getElementMobile(this.getX(), this.getY()+1);
					final ElementMobile est3 = this.map.getElementMobile(this.getX(), this.getY()-1);
					...
					else if(!this.map.getXY(x+1, y).estVide()){
					...
					final ElementMobile sud1 = this.map.getElementMobile(this.getX(), this.getY()+1);
					final ElementMobile sud2 = this.map.getElementMobile(this.getX()+1, this.getY());
					final ElementMobile sud3 = this.map.getElementMobile(this.getX()-1, this.getY());
					...
					else if(!this.map.getXY(x, y+1).estVide()){
						if(tourne%3==0 && tourne!=0){
							this.direction=NORD;
							demiTour=true;
						}
					...
					final ElementMobile ouest1 = this.map.getElementMobile(this.getX()-1, this.getY());
					final ElementMobile ouest2 = this.map.getElementMobile(this.getX(), this.getY()+1);
					final ElementMobile ouest3 = this.map.getElementMobile(this.getX(), this.getY()-1);
